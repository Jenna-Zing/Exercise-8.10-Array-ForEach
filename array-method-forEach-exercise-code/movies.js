...
// TODO:  Use the array method `forEach` to iterate over this array using the `forEach` method and log a message for each movie in the format: `"Title (Year) directed by Director"`.
